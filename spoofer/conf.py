...
noauth_or_username.add_argument('--noauth', dest='noauth', action='store_true', help='Nonaktifkan pemeriksaan autentikasi')
...
required.add_argument('--port', dest='port', type=int, required=True, help='SMTP nomor port')

# Email composition arguments
required.add_argument('--sender', dest='sender', required=True, type=str, help='Alamat pengirim (Cth. bintangbokep@domain.com)')
required.add_argument('--name', dest='name', required=True, type=str, help='Nama Pengirim (Cth. GLorius HeLL)')
required.add_argument('--recipients', dest='recipients', required=True, type=str, nargs='+', help='Email Tujuan (Cth. masihperawan@domain.com ...)')
required.add_argument('--subject', dest='subject', required=True, type=str, help='Subject line')
required.add_argument('--filename', dest='filename', required=True, type=str, help='Isi pesan (Cth. contoh.html)')
